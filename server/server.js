...
Meteor.startup(function () {
  ...
  if (RouteShapes.find().count() === 0) {
      ...
      //   var exists = RouteShapes.find({id: split[0]});
      //   if (exists) {
      //     RouteShapes.
      //   }
      // }
      //   RouteShapes.upsert({_id: split[0]}, {
      //     shape_pt_sequence: split[1],
      //     shape_pt_lat: split[2],
      //     shape_pt_lon: split[3],
      //     shape_dist_traveled: split[4]
      //   });
